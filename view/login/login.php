                                    ...
                                    if(isset($_GET['pesan'])){
                                        if($_GET['pesan'] == "gagal"){ ?>
                                            <div class="alert alert-danger mb-2" role="alert">
                                                <strong>Oh snap!</strong> User tidak terdaftar atau Password yang anda masukkan salah.
                                            </div>
                                        <?php }else if($_GET['pesan'] == "logout"){ ?>
                                            <div class="alert alert-success mb-2" role="alert">
                                                <strong>Logout !</strong> Anda berhasil logout dari sistem.
                                            </div>
                                        <?php }else if($_GET['pesan'] == "belum_login"){ ?>
                                            <div class="alert alert-info mb-2" role="alert">
                                                Anda harus login untuk mengakses halaman selanjutnya.
                                            </div>
                                        <?php }
                                    }
                                    ?>
                                </div>
                                <form class="form-horizontal form-simple" action="../../action/act_login.php" method="post" novalidate>
